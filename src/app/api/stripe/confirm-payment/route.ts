...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("🚀 ~ POST ~ paymentIntentId:", paymentIntentId);
    ...
    try {
      // const customerEmail = orderData.guestEmail || orderData.userId;
          ...
          <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            ...
            <table style="width: 100%;">
              ...
              <tr>
                ...
                <td style="padding: 8px 0; text-align: right;"><span style="background-color: #d1fae5; color: #065f46; padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: bold;">PAID</span></td>
              </tr>
            </table>
          </div>
